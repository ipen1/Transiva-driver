...
public final class OrderStatusPresentation {
    ...
    public static String label(String rawStatus, String rawType) {
        ...
        switch (s) {
            ...
            case "taken": return "Driver Menuju Penjemputan";
            case "arrived_pickup": return isFood(t) ? "Driver Tiba di Restoran" : "Driver Tiba di Penjemputan";
            case "on_delivery": return isFood(t) ? "Menuju Lokasi Customer" : "Menuju Lokasi Pengantaran";
            case "arrived_delivery": return isFood(t) ? "Driver Tiba di Customer" : "Driver Tiba di Pengantaran";
    ...
    public static String description(JSONObject o) {
        ...
        switch(s){
            ...
            case "taken": return isFood(t)?d+" sedang menuju restoran":d+" sedang menuju titik penjemputan";
            case "arrived_pickup": return isFood(t)?d+" sudah tiba di restoran":d+" sudah tiba di titik penjemputan";
            case "on_delivery": return isFood(t)?d+" sedang mengantar pesanan ke customer":d+" sedang menuju titik pengantaran";
            case "arrived_delivery": return isFood(t)?d+" sudah tiba di lokasi customer":d+" sudah tiba di titik pengantaran";
