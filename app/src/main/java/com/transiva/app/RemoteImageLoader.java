...
public final class RemoteImageLoader {
    ...
    private static void load(ImageView view,String clean){
        ...
        try{
            c=com.transiva.app.driver.data.DriverConnectionRepository.open(clean); c.setConnectTimeout(10000);c.setReadTimeout(15000);c.setUseCaches(true);c.setRequestProperty("Accept","image/webp,image/*");
